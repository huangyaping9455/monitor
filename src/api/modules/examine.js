...
export default {
  ...
  // 自治区通报线索-分页
  getreportingClueList(data) {
    return $axios.post("/blade-anbiao/anbiao/reportingClueInfo/getTJ", data);
  },
  // 自治区通报线索-新增
  getreportingClueInsert(data) {
    return $axios.post("/blade-anbiao/anbiao/reportingClueInfo/insert", data);
  },
  awaitWrap,
};
