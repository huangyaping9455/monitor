...
export default {
  ...
  // 获取送达企业列表
  getQiYe(params) {
    return $axios.get('/blade-anbiao/anbiao/xinxijiaohuzhuti/getQiYe',{ params: params });
  },
  // 政府-获取统计车辆数据
  getVehicleList(params) {
    return $axios.get('/blade-anbiao/anbiao/gpsVehicle/getVehicleList',{ params: params });
  },
  // 政府-获取政府组织树结构数据
  getTree(params) {
    return $axios.get('/blade-anbiao/anbiao/organization/getTree',{ params: params });
  },
  awaitWrap
};