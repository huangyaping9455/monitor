...
<template>
  <div class="home-header">
    ...
    <!-- <h1 class="title" style="font-size: 25px;display: flex;justify-content: center;">
      <img src="@/assets/img/lzlogo.png" style="width: 30px;height: 35px;margin-right: 2px;" />
      <span>柳州市交通运输卫星定位政府监管平台</span>
    </h1> -->
