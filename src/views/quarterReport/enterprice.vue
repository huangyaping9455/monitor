    ...
    <div class="main" style="display: flex">
      <div class="main-r">
        ...
        <el-form v-show="searchshow" :inline="true" size="mini" :model="form" class="search">
          ...
          <el-form-item>
            <el-button type="primary" class="sbtn" @click="getZFBJTJJS(1)">搜索</el-button>
          </el-form-item>
        </el-form>
        <!-- mainTable -->
        <el-table
        ...
        >
          ...
          <el-table-column prop="countdate" label="统计日期" align="center"></el-table-column>
          <el-table-column prop="createtimeshow" label="监控时间" align="center"></el-table-column>
          <el-table-column prop="caozuoren" label="报告制作人" align="center"></el-table-column>
        </el-table>
        <!-- page -->
        <div class="page">
          <div class="page-l">
          ...
          <div class="page-r">
            ...
            <span class="el-icon-arrow-left" @click="getZFBJTJJS(current - 1)"></span>
            <span class="num" v-show="current - 2 > 0" @click="getZFBJTJJS(current - 2)">{{
              current - 2
            }}</span>
            <span class="num" v-show="current - 1 > 0" @click="getZFBJTJJS(current - 1)">{{
              current - 1
            }}</span>
            <span class="num active">{{ current }}</span>
            <span class="num" v-show="current + 1 <= pageTotal" @click="getZFBJTJJS(current + 1)">{{
              current + 1
            }}</span>
            <span class="num" v-show="current + 2 <= pageTotal" @click="getZFBJTJJS(current + 2)">{{
              current + 2
            }}</span>
            <span class="el-icon-arrow-right" @click="getZFBJTJJS(current + 1)"></span>
            <span class="el-icon-d-arrow-right" @click="getZFBJTJJS(pageTotal)"></span>
            <div class="pagesize">
              每页显示
              <el-select
                class="showselect"
