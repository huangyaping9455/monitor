        ...
        <div class="page">
          ...
          <div class="page-r">
            <span
              ...
              @click="getDQIntoAreaPMTJ(1)"
            ></span>
            <span
              class="el-icon-arrow-left"
              @click="getDQIntoAreaPMTJ(current - 1)"
            ></span>
            <span
              class="num"
              v-show="current - 2 > 0"
              @click="getDQIntoAreaPMTJ(current - 2)"
              >{{ current - 2 }}</span
            >
            <span
              class="num"
            ...
            <span
              ...
              @click="getDQIntoAreaPMTJ(pageTotal)"
            ></span>
            <div class="pagesize">
              每页显示
              <el-select
...
export default {
  ...
  methods: {
    //报警统计结算
    async getDQIntoAreaPMTJ(current = 1) {
      current = Number(current);
      this.loading = true;
      let [err, data] = await dataAnalysisApi.awaitWrap(
        dataAnalysisApi.getDQIntoAreaPMTJ({
