  ...
  <div class="enterprise">
    <div class="main" style="display: flex">
      <div class="main-r">
        ...
        >
          ...
          <el-table-column label="运营商名称" align="center">
            <template slot-scope="{ row }">
              <span class="businessName">{{ row.opName }}</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="countdate"
      ...
      <div class="main-pre" v-if="previewshow">
        ...
        >
          <excel-preview :file="fileUrl" :key="fileUrl"></excel-preview>
        </div>
...
import ExcelPreview from "../../components/index-book/preview/excelPreview.vue";
