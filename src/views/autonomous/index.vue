...
<template>
  <div class="main">
    ...
    <div class="btns">
      ...
      <el-button @click="addShow" size="mini" class="btn" icon="el-icon-plus">
        新增
      </el-button>
    </div>
    <!-- 查询 -->
    ...
    >
      ...
      <el-table-column prop="rcName" label="文件名称" align="center" :show-overflow-tooltip="true">
      </el-table-column>
      <el-table-column prop="rcDate" label="上传时间" align="center" :show-overflow-tooltip="true">
      </el-table-column>
  ...
  methods: {
    ...
    async getDeptDayTJ(current = 1) {
      ...
      let [err, data] = await dataAnalysisApi.awaitWrap(
        dataAnalysisApi.getreportingClueList({
    ...
    // 新增
    addShow() {
      this.$refs.autos.open({}, "新增自治区通报");
    },
    // 详情
    detailShow(row) {
      this.$refs.autos.open(row, "编辑自治区通报");
    },
  },
};
</script>
