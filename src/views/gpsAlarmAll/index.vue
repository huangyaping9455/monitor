    ...
    <div class="main">
      ...
      <div class="main-r">
        ...
        >
          ...
          <el-table-column
            label="驾驶员异常报警"
            prop="safeAbnormalAlarmNum"
            align="center"
            show-overflow-tooltip
          ></el-table-column>
          <el-table-column
            label="接打电话报警"
            prop="safePhoneAlarmNum"
            align="center"
            show-overflow-tooltip
          ></el-table-column>
          <el-table-column
            label="疲劳驾驶报警"
            prop="safeFatigueAlarmNum"
            align="center"
            show-overflow-tooltip
          ></el-table-column>
          <el-table-column
            label="分神驾驶报警"
            prop="safeDistractionAlarmNum"
            align="center"
            show-overflow-tooltip
          ></el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="{ row }">
              <span>{{
                Number(row.overspeedAlarmNum) +
                Number(row.safeAbnormalAlarmNum) +
                Number(row.safePhoneAlarmNum) +
                Number(row.safeFatigueAlarmNum) +
                Number(row.safeDistractionAlarmNum)
              }}</span>
            </template>
          </el-table-column>
        </el-table>
    ...
    async downtable() {
      ...
      if (data) {
        data = data.records.map((el, index) => {
          ...
          el.all =
            Number(el.overspeedAlarmNum) +
            Number(el.safeAbnormalAlarmNum) +
            Number(el.safePhoneAlarmNum) +
            Number(el.safeFatigueAlarmNum) +
            Number(el.safeDistractionAlarmNum);
          return {
            ...el,
            index: index + 1,
          };
    ...
    export2Excel(list) {
      require.ensure([], () => {
        ...
        filterVal = [
          ...
          "areaname",
          "overspeedAlarmNum",
          "safeAbnormalAlarmNum",
          "safePhoneAlarmNum",
          "safeFatigueAlarmNum",
          "safeDistractionAlarmNum",
          "all",
        ];
        merges = [
          "A1:A2",
