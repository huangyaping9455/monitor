    ...
    <div class="main">
      ...
      <div class="main-r">
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" class="sbtn" @click="getYYSZFBJTJJS(1)"
              >搜索</el-button
            >
          </el-form-item>
        </el-form>
        ...
        <div class="page">
          ...
          <div class="page-r">
            <span
              ...
              @click="getYYSZFBJTJJS(1)"
            ></span>
            <span
              class="el-icon-arrow-left"
              @click="getYYSZFBJTJJS(current - 1)"
            ></span>
            <span
              class="num"
              v-show="current - 2 > 0"
              @click="getYYSZFBJTJJS(current - 2)"
              >{{ current - 2 }}</span
            >
            <span
              class="num"
            ...
            <span
              ...
              @click="getYYSZFBJTJJS(pageTotal)"
            ></span>
            <div class="pagesize">
              每页显示
              <el-select
...
export default {
  ...
  methods: {
    //报警统计结算
    async getYYSZFBJTJJS(current = 1) {
      current = Number(current);
      this.loading = true;
      let [err, data] = await dataAnalysisApi.awaitWrap(
        dataAnalysisApi.getYYSZFBJTJJS({
          // deptId:5448,
